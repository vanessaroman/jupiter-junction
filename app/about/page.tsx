...
export default function GridBlurredBackdrop() {
  return (
    <Flex
      ...
      overflow={'hidden'}
      bg={'black'}>
      <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'} padding-bottom={'20px'}>
        <chakra.h3
        ...
        <chakra.h1
          ...
          Cultivating community in the Houston area
        </chakra.h1>
      ...
      <Box pb={'10'}>
        <Icon viewBox="0 0 40 35" mt={14} boxSize={10} color={'#fd90ad'} >
          <path
            fill={'currentColor'}
